...
class _EmployeeDetailPageState extends State<EmployeeDetailPage> {
  ...
  Future<Employee> fetchEmployeeDetail() async {
    final response = await http.get(Uri.parse('https://oltinwash.pythonanywhere.com/employees/api/employee/${widget.employeeId}/'));
  ...
  Future<void> fireEmployee(int employeeId) async {
    final response = await http.post(
      Uri.parse('https://oltinwash.pythonanywhere.com/api/employees/$employeeId/fire/'),
    );
